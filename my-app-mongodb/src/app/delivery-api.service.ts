...
export class DeliveryApiService {
  ...
  getDelivery(page: number, pageSize: number, search?: string, sortBy?: string, sortOrder: 'asc' | 'desc' = 'asc'): Observable<{ data: Delivery[]; total: number }> {
    ...
    return this.http.get<{ data: Delivery[]; total: number }>(this.apiUrl, { params }).pipe(
      retry(3),
